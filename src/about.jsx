        ...
        <div>
          ...
          <div className="col-wrapper">
            <div className="col-two">
              ...
              <p>I currently reside in <strong>Toronto</strong> trying to figure out how to adult</p>
              ...
              <p>If I'm not coding you can find me colouring, practicing yoga, watching FRIENDS, or playing with my cat, Coco.</p>
            </div>
            </div>
        </div>
  		</section>
